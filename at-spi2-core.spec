...
Source0  : https://download.gnome.org/sources/at-spi2-core/2.56/at-spi2-core-2.56.1.tar.xz
...
%prep
%setup -q -n at-spi2-core-2.56.1
cd %{_builddir}/at-spi2-core-2.56.1
pushd ..
cp -a at-spi2-core-2.56.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743460097
...
/V3/usr/lib64/libatk-1.0.so.0.25610.1
...
/usr/lib64/libatk-1.0.so.0.25610.1
