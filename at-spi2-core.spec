...
Source0  : https://download.gnome.org/sources/at-spi2-core/2.56/at-spi2-core-2.56.2.tar.xz
...
%prep
%setup -q -n at-spi2-core-2.56.2
cd %{_builddir}/at-spi2-core-2.56.2
pushd ..
cp -a at-spi2-core-2.56.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745878228
...
/V3/usr/lib64/libatk-1.0.so.0.25611.1
...
/usr/lib64/libatk-1.0.so.0.25611.1
