...
%prep
%setup -q -n at-spi2-core-2.30.0
pushd ..
cp -a at-spi2-core-2.30.0 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1536130340
...
%install
mkdir -p %{buildroot}/usr/share/doc/at-spi2-core
cp COPYING %{buildroot}/usr/share/doc/at-spi2-core/COPYING
pushd ../build32
