...
Source0  : https://download.gnome.org/sources/at-spi2-core/2.32/at-spi2-core-2.32.0.tar.xz
...
%prep
%setup -q -n at-spi2-core-2.32.0
pushd ..
cp -a at-spi2-core-2.32.0 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1552400380
