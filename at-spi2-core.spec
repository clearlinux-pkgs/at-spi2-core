...
Source0  : https://download.gnome.org/sources/at-spi2-core/2.24/at-spi2-core-2.24.1.tar.xz
...
%prep
%setup -q -n at-spi2-core-2.24.1
pushd ..
cp -a at-spi2-core-2.24.1 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1503069081
