...
Source0  : https://download.gnome.org/sources/at-spi2-core/2.40/at-spi2-core-2.40.0.tar.xz
...
%prep
%setup -q -n at-spi2-core-2.40.0
cd %{_builddir}/at-spi2-core-2.40.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618928777
...
cp %{_builddir}/at-spi2-core-2.40.0/COPYING %{buildroot}/usr/share/package-licenses/at-spi2-core/01a6b4bf79aca9b556822601186afab86e8c4fbf
