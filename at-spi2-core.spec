...
Source0  : https://download.gnome.org/sources/at-spi2-core/2.40/at-spi2-core-2.40.1.tar.xz
...
%prep
%setup -q -n at-spi2-core-2.40.1
cd %{_builddir}/at-spi2-core-2.40.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620061991
...
cp %{_builddir}/at-spi2-core-2.40.1/COPYING %{buildroot}/usr/share/package-licenses/at-spi2-core/01a6b4bf79aca9b556822601186afab86e8c4fbf
