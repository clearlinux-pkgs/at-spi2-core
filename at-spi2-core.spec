...
Source0  : https://download.gnome.org/sources/at-spi2-core/2.34/at-spi2-core-2.34.0.tar.xz
...
%prep
%setup -q -n at-spi2-core-2.34.0
pushd ..
cp -a at-spi2-core-2.34.0 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568070833
