...
Source0  : https://download.gnome.org/sources/at-spi2-core/2.40/at-spi2-core-2.40.3.tar.xz
...
%prep
%setup -q -n at-spi2-core-2.40.3
cd %{_builddir}/at-spi2-core-2.40.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1625850365
...
cp %{_builddir}/at-spi2-core-2.40.3/COPYING %{buildroot}/usr/share/package-licenses/at-spi2-core/01a6b4bf79aca9b556822601186afab86e8c4fbf
