...
Source0  : https://download.gnome.org/sources/at-spi2-core/2.50/at-spi2-core-2.50.0.tar.xz
...
%prep
%setup -q -n at-spi2-core-2.50.0
cd %{_builddir}/at-spi2-core-2.50.0
pushd ..
cp -a at-spi2-core-2.50.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695666377
...
/V3/usr/lib64/libatk-1.0.so.0.25009.1
...
/usr/lib64/libatk-1.0.so.0.25009.1
