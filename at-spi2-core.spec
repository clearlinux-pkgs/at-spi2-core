...
Source0  : https://download.gnome.org/sources/at-spi2-core/2.26/at-spi2-core-2.26.2.tar.xz
...
%prep
%setup -q -n at-spi2-core-2.26.2
pushd ..
cp -a at-spi2-core-2.26.2 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1510233273
