...
Source0  : https://download.gnome.org/sources/at-spi2-core/2.42/at-spi2-core-2.42.0.tar.xz
...
%prep
%setup -q -n at-spi2-core-2.42.0
cd %{_builddir}/at-spi2-core-2.42.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632417410
...
cp %{_builddir}/at-spi2-core-2.42.0/COPYING %{buildroot}/usr/share/package-licenses/at-spi2-core/01a6b4bf79aca9b556822601186afab86e8c4fbf
